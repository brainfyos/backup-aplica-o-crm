                ...
                {plans.map((plan) => {
                  ...
                  return (
                    <TableRow key={plan.id}>
                      ...
                      <TableCell>
                        {plan.feature_mia ? (
                          <Badge className="bg-fuchsia-500/10 text-fuchsia-600 border-fuchsia-500/20">Incluída</Badge>
                        ) : (
                          <Badge variant="outline" className="text-muted-foreground">Não incluída</Badge>
                        )}
                      </TableCell>
