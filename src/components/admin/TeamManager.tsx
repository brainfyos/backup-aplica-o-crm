...
import { TransferAllAssignmentsDialog } from './team/TransferAllAssignmentsDialog';
...
export function TeamManager() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <div className="hidden">{/* layout marker */}</div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Select value={roleFilter} onValueChange={setRoleFilter}>
          ...
          <SelectContent>
            ...
            <SelectItem value="seller">Usuários</SelectItem>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {filteredMembers.map((member) => (
          <MemberCard
            ...
            onTransferAssignments={(m) => setTransferMember(m)}
          ...
          {editingMember && (
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={selectedRole} onValueChange={(v: 'admin' | 'seller') => setSelectedRole(v)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
      ...
      <AlertDialog open={!!memberToRemove} onOpenChange={(open) => !open && setMemberToRemove(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Remover usuário desta empresa</AlertDialogTitle>
            <AlertDialogDescription>
              <strong>{memberToRemove?.full_name}</strong> será removido desta empresa: papel, setores,
              squads, permissões e leads vinculados aqui serão liberados.
              <br /><br />
              Se ele também participar de outra empresa, o acesso a ela é mantido. Caso esta seja a
              única empresa dele, a conta de acesso será excluída permanentemente.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
              ...
              onClick={() => {
                if (memberToRemove) {
                  removeMember.mutate(memberToRemove.id, {
                    onSuccess: (res: any) => {
                      toast.success(
                        res?.mode === 'removed_from_organization'
                          ? 'Usuário removido desta empresa (acesso às outras empresas mantido)'
      ...
      <TransferAllAssignmentsDialog
        open={!!transferMember}
        onOpenChange={(o) => { if (!o) setTransferMember(null); }}
