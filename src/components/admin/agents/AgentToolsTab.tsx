...
import { ProductAgent, QualificationSchema } from '@/types/agents';
      ...
      <Card>
        ...
        <CardContent className="px-4 pb-3 space-y-1">
          ...
          <ToolToggle
            ...
            label="Nunca pedir email do cliente"
            description="A IA fica proibida de solicitar email em qualquer situação. Ideal quando o contato acontece só por WhatsApp."
            checked={formData.never_ask_email ?? false}
            onCheckedChange={(v) => onChange({ never_ask_email: v })}
          />
          <ToolToggle
