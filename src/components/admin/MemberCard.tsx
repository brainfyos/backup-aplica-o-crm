...
import { Shield, UserCog, User, Mail, MoreVertical, Users, Package, Trash2, Settings2, ArrowRightLeft } from 'lucide-react';
...
interface MemberCardProps {
  ...
  onTransferAssignments: (member: TeamMember) => void;
  onRemove: (member: TeamMember) => void;
}

export function MemberCard({ member, onEditRole, onEditSquad, onAssignProduct, onEditPermissions, onTransferAssignments, onRemove }: MemberCardProps) {
        ...
        <div className="flex items-start justify-between">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => onTransferAssignments(member)}>
